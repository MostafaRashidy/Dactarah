                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="relative">
                            ...
                            <div id="userActionsMenu" class="hidden absolute right-0 mt-2 w-56 bg-white rounded-md shadow-lg z-20 border border-gray-200">
                                <div class="py-1">
                                    ...
                                    <button id="bulkDeleteBtn" class="w-full text-right px-4 py-2 text-sm text-red-600 hover:bg-red-50">
                    ...
                    <div class="mb-6 bg-gray-50 p-4 rounded-md shadow-md border border-gray-200">
                        <form id="filterForm" method="GET" action="{{ route('admin.users.index') }}" class="flex flex-wrap gap-4 items-center">
                            <!-- Hidden page input -->
                    ...
                    <div class="overflow-x-auto bg-white rounded-md shadow">
                        <table class="w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th class="px-4 py-3">
                                        <input type="checkbox" id="selectAllCheckbox" class="rounded border-gray-300 text-blue-600 shadow-sm">
                                    </th>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Utility function for loading alert
    ...
    document.querySelectorAll('.pagination a').forEach(link => {
        link.addEventListener('click', function(e) {
            ...
            showLoadingAlert('جاري تحميل الصفحة...');
    ...
    window.removeSearchFilter = function() {
        Swal.fire({
            title: 'مسح البحث',
            text: 'هل أنت متأكد من مسح نتائج البحث؟',
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    .then(data => {
                        Swal.fire({
                            title: 'تم الحذف!',
                            text: data.message || 'تم حذف المستخدم بنجاح',
                            icon: 'success'
                        }).then(() => {
                            location.reload();
                        });
            ...
            if (result.isConfirmed) {
                ...
                .then(data => {
                    if (data.success) {
                        Swal.fire({
                            title: 'تم الحذف!',
                            text: data.message || 'تم حذف المستخدمين بنجاح',
                            icon: 'success'
                        }).then(() => {
                            location.reload();
                        });
