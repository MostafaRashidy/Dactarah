    ...
    <div x-data="{ open: false }" class="relative inline-block">
        ...
        <div x-show="open"
            ...
            <div class="py-1">
                ...
                @else
                    <button onclick="updateDoctorStatus('{{ $doctor->status === 'inactive' ? 'active' : 'inactive' }}')"
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:text-right sm:w-full">
                            ...
                            <div class="mt-2">
                                <textarea name="rejection_reason"
                                          ...
                                          rows="4"
                                          placeholder="اذكر سبب رفض الطبيب (اختياري)"
                                          ></textarea>
                            </div>
                        </div>
                    </div>
...
function showRejectModal() {
    Swal.fire({
        title: 'سبب رفض الطبيب',
        input: 'textarea',
        inputPlaceholder: 'اذكر سبب رفض الطبيب (اختياري)',
        showCancelButton: true,
        confirmButtonText: 'تأكيد الرفض',
        cancelButtonText: 'إلغاء',
        preConfirm: (reason) => {
            return axios.patch('{{ route("admin.doctors.update.status", $doctor) }}', {
                status: 'rejected',
