                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-6">
                        ...
                        <div class="relative my-4">
                            ...
                            <div class="relative flex justify-center">
                                <span class="px-2 bg-white text-gray-500 text-sm">أو سجل الدخول عبر</span>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <button
                                type="button"
                                class="flex items-center justify-center gap-2 py-3 border-2 border-gray-200 rounded-xl hover:bg-gray-50 transition-colors"
                            >
