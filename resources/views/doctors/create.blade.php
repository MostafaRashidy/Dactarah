                ...
                <div class="p-8 md:p-12 space-y-8">
                    ...
                    <div class="text-center space-y-4">
                        ...
                        <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                            كن جزءاً من أكبر شبكة أطباء مبتكرة ومتطورة في المنطقة
                        </p>
                    </div>

                    <!-- Form with Modern Layout -->
                    <form method="POST" action="{{ route('doctors.store') }}" enctype="multipart/form-data" class="space-y-8" id="application">
                        @csrf

                        <!-- Profile Image Upload with Hover Effect -->
                        <div class="flex justify-center">
                            <div class="relative group">
                                <div id="preview"
                                    class="w-48 h-48 rounded-full bg-gradient-to-br from-blue-100 to-purple-100
                                    border-4 border-white shadow-lg flex items-center justify-center
                                    cursor-pointer transition-all duration-300
                                    hover:scale-105 hover:shadow-xl group-hover:border-blue-300"
                                    onclick="document.getElementById('usr_img').click()">
                                    <div class="upload-icon text-center p-4 group-hover:opacity-70 transition-opacity">
                                        ...
                                        <p class="mt-2 text-sm text-gray-600 group-hover:text-blue-700">
                                            اضغط لرفع صورة
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="email" name="communication_email" required
                                        class="w-full px-4 py-3 rounded-xl
                                        bg-gray-100/50 border border-gray-200
                                        focus:ring-2 focus:ring-blue-300
                                        focus:border-blue-500
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea name="description" rows="4" maxlength="150" required
                                    ...
                                    focus:border-blue-500
                                    transition-all duration-300
                                    hover:bg-blue-50/50">{{ old('description') }}</textarea>
                            ...
                            <div>
                                ...
                                <button type="button" onclick="getLocation()"
                                    class="mb-4 inline-flex items-center px-4 py-2
                        ...
                        <div>
                            <button type="submit"
                                class="submit-button w-full py-4 rounded-xl
